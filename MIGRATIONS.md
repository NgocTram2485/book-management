...
INSERT INTO book_management.publishers (id, name, created_at, updated_at) VALUES (6, 'Nhà xuất 10X', '2024-01-08 06:56:50', '2024-01-08 06:56:50');

INSERT INTO book_management.books (id, name, author, category_id, publisher_id, status, avatar, price, qty, created_at, updated_at) VALUES (1, 'BLeaf', 'NHD', 4, 6, 'active', '', 8000, 8000, '2023-04-12 17:00:00', '2023-04-12 17:00:00');
INSERT INTO book_management.books (id, name, author, category_id, publisher_id, status, avatar, price, qty, created_at, updated_at) VALUES (2, 'Nhà Giả Kim', 'Paulo Coelho', 1, 1, 'active', '', 69000, 100, '2024-01-05 16:32:26', '2024-01-08 06:28:12');
INSERT INTO book_management.books (id, name, author, category_id, publisher_id, status, avatar, price, qty, created_at, updated_at) VALUES (3, 'Doraemon', 'Fujiko F. Fujio', 2, 5, 'active', '', 20000, 1000, '2024-01-06 15:25:59', '2024-01-08 07:06:51');
